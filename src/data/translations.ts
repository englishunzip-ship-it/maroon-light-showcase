export const translations = {
  en: {
    ...
    profile: {
      ...
      description: "I create smart digital solutions that simplify work and empower communities. As a self-driven Web Developer & IT Specialist behind projects like BOBDO, ZiptoCode Tech Solution and YouthHopeBD, I combine technical expertise, leadership, and innovation to drive positive change.",
  ...
  bn: {
    ...
    profile: {
      ...
      description: "আমি স্মার্ট ডিজিটাল সমাধান তৈরি করি যা কাজ সহজ করে এবং সম্প্রদায়কে ক্ষমতায়িত করে। BOBDO, ZiptoCode Tech Solution এবং YouthHopeBD-এর মতো প্রকল্পের পেছনে একজন স্ব-চালিত ওয়েব ডেভেলপার ও আইটি বিশেষজ্ঞ হিসেবে, আমি প্রযুক্তিগত দক্ষতা, নেতৃত্ব এবং উদ্ভাবনকে একত্রিত করে ইতিবাচক পরিবর্তন আনি।",
